...
# 6 "syscall_example1.c" 2
# 1 "syscallmacros.h" 1
# 7 "syscall_example1.c" 2
...
//please refer to Professional Assembly Language - Richard Blum - Wrox

//the following in-line assembly code uses extended assembly 
//language coding
//

//long __res - local variable used in in-line assembly code

//__asm__ - alternate keyword(not asm) to identify in-line assembly code

//volatile modifier - compiler leaves the code as it is - no rearrangement

//int $0x80 - syscall machine instruction - used in x86

//"=a" (__res) - return value from the system call system routine is stored //               in eax
//               eax value is copied to __res and __res is designated
//               as write only in the in-line assembly

//"0"(20) - copy the value 20 in eax register - eax is identified using
//          place-holder format of extended assembly language programming

//finally, out of the in-line assembly and manipulating error code 
